...
function main() {
  ...
  if(!even) {
    console.log('You have an error with your even logic in your oddOrEven function')
  } else if(!odd) {
    console.log('You have an error with your odd logic in your oddOrEven function')
  } else {
